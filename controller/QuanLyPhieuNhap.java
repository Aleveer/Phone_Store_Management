...
public class QuanLyPhieuNhap extends PhieuNhap implements ControllerInterface{
    ...
    public void Read() {
        ...
        String header = String.format("| %-10s | %-25s | %-16s | %-14s | %-28s | %-15s | %-15s |", "Giá Tiền", "Mã Nhà Cung Cấp", "Mã Nhân Viên", "Mã phiếu nhập", "Tên Nhà Cung Cấp", "Ngày Nhập", "Giờ Nhập");
        System.out.format("+------------+---------------------------+------------------+----------------+--------------------------------+-----------------+-----------------+%n");
        ...
        for (PhieuNhap phieunhap : DSPN) {
                String read = String.format("| %-10s | %-25s | %-16s | %-14s | %-28s | %-15s | %-15s |", phieunhap.getPrice(), phieunhap.getID_Supplier(), phieunhap.getID_Worker(),
    ...
    public void Update() {
        try {
            ...
            System.out.println(header);
            System.out.format("+------------+---------------------------+------------------+----------------+--------------------------------+-----------------+-----------------+%n");
            String row = String.format("| %-10s | %-25s | %-16s | %-14s | %-28s | %-15s | %-15s |",
    ...
    public void Search_byCategory() {
        ...
        for (PhieuNhap phieunhap : result) {
            String read = String.format("| %-10s | %-25s | %-16s | %-14s | %-28s | %-15s | %-15s |", phieunhap.getPrice(), phieunhap.getID_Supplier(),
