...
public class QuanlyChiTietPhieuNhap extends ChiTietPhieuNhap implements DataAccessObject{
	  ...
	  public ChiTietPhieuNhap[] getListCTPN() throws FileNotFoundException {
	        String[] result = Stream.read("src/database/deliveryReceivedDetail.txt");
	  ...
	  public void waitConsole() {
	    ...
	    public void Read() throws FileNotFoundException {
	        ...
	        for (ChiTietPhieuNhap chiTietPhieuNhap : DSCTPN) {
	                String read = String.format("| %-13s | %-10s | %-11s | %-25s |", chiTietPhieuNhap.getID_PhieuNhap(), chiTietPhieuNhap.getID_Product(), chiTietPhieuNhap.getAmount(),
