...
public class QuanLyPhieuNhap extends PhieuNhap {
    ...
    public PhieuNhap[] getListPhieuNhap() throws FileNotFoundException {
        String[] result = Stream.read("src/DuLieu/Phieunhap.txt");
    ...
    public void read() throws FileNotFoundException {
        ...
        for (PhieuNhap phieunhap : DSPN) {
            if (DSPN[0].getID_PhieuNhap().contains("DSPN")) {
    ...
    public void Add() {
        ...
        try {
            ...
            Stream.addOneLine("src/DuLieu/Phieunhap.txt", input);
    ...
    public void Update() {
        try {
            ...
            try {
                Stream.addAll("src/DuLieu/Phieunhap.txt", data);
    ...
    public void Search_byCategory() {
        ...
        System.out.println("\t\t\t\t\t\t\t\t |6.Ngày nhập                              |");
        System.out.println("\t\t\t\t\t\t\t\t |7.Giờ nhập                               |");
        System.out.println("\t\t\t\t\t\t\t\t +-----------------------------------------+");
        ...
        if (choose == 0)
            ...
            switch (choose) {
                ...
                case 6 -> {
                    ...
                    LocalDate ngaynhap = LocalDate.parse(input.nextLine());
                    for (PhieuNhap phieunhap : DSPN) {
                        if (phieunhap.getNgayNhap().isEqual(ngaynhap)) {
                            result = addPhieuNhap(result, phieunhap);
                        }
                    }
                }
                case 7 -> {
                    ...
                    LocalTime gionhap = LocalTime.parse(input.nextLine());
                    for (PhieuNhap phieunhap : DSPN) {
                        if (gionhap.getHour() == getGioNhap().getHour()) {
                            result = addPhieuNhap(result, phieunhap);
                        }
                    }
                }
    ...
    public void Output() {
        ...
        for (PhieuNhap DSPN : DSPN) {
            String row = String.format("|\t\t%s\t\t\t|\t%s\t\t|\t%s|\t\t%s\t\t|\t%s\t|\t%s\t\t|\t%s\t" + "|",
                    DSPN.getPrice(), DSPN.getID_Supplier(), DSPN.getID_Worker(), DSPN.getID_PhieuNhap(), DSPN.getName_supplier(),
                    DSPN.getNgayNhap(), DSPN.getGioNhap());
            System.out.println(row);
            waitConsole();
        }
    }
