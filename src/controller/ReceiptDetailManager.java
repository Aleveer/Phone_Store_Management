...
public class ReceiptDetailManager extends ReceiptDetail{
	...
	public void Update() {
        ...
        for (ReceiptDetail receipt : rd) {
            if (receipt.getID_Receipt().equals(ID_Receipt) && receipt.getID_Product().equals(ID_Product)) {
                cthd = receipt;
                break;
            }
        }
        ...
        for (int i = 0; i < rd.length; i++) {
            if (rd[i].getID_Receipt().equals(ID_Receipt) && rd[i].getID_Product().equals(ID_Receipt)) {
            	input.nextInt();
